...
public class InfluenceTest {
    ...
    @Before
    public void setUp() {
        p1 = new Player(new Homebase(), new ArrayList<Train>(), new Gold(100), new Fuel(20, 0));
        p2 = new Player(new Homebase(), new ArrayList<Train>(), new Gold(100), new Fuel(20, 0));
        p3 = new Player(new Homebase(), new ArrayList<Train>(), new Gold(100), new Fuel(20, 0));
